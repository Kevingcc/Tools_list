...
def cmdLineParser():
    ...
    login = parser.add_argument_group('LGIN')

    login.add_argument('-luz','--zoom_u',help='Zoomeye login username.')
    login.add_argument('-lup','--zoom_p',help='Zoomeye login password.')
